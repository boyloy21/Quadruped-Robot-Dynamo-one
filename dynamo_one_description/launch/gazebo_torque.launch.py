...
from launch.actions import DeclareLaunchArgument, OpaqueFunction, IncludeLaunchDescription, RegisterEventHandler, ExecuteProcess, TimerAction
...
def launch_setup(context, *args, **kwargs):
    ...
    init_height = '0.2'  # Set height explicitly to 1.0
    ...
    robot_description = xacro.process_file(
        ...
        mappings={
            ...
            'CONTROL': 'false'  # select gazebo_torque.xacro
        }
    ).toxml()
    ...
    Initial_joint_torque = Node(
        package='dynamo_one_description',
        executable='initialjointtorque.py',
        name='Initialjointtorque',
        output='screen',
    )
