...
class Gait_control(Node):
    ...
    def Q_update(self):
        ...
        self.foot_positions, self.Q_history = self.cpg.generate(gait_type=self.command_gait, Ts=self.Ts,  step_length=self.step_length, step_height=self.step_height, z=self.z, move_direction=self.move_direction)
