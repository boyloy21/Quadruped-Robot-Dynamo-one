...
class RestController(object):
    def __init__(self, defult_stance):
        self.def_stance = defult_stance
    ...
    def updateStateCommand(self, msg, state, command):
        ...
        if self.use_button:
            if msg.buttons[7]:
                ...
                rclpy.logging.get_logger().info(f"Rest Controller - Use roll/pitch compensation: {self.use_imu}")
    ...
    def step(self, state, command):
        ...
        if self.use_imu == True:
            ...
            rot = rotxyz(roll_compensation, pitch_compensation, 0.0)
