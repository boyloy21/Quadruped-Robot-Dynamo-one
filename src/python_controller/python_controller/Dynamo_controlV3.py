...
class Gait_control(Node):
    def __init__(self):
        ...
        # PID Controller
        self.pid = PID_controller(65*self.dt, 0.0, 0.0)
        self.pid.reset()
    ...
    def control_loop(self):
        ...
        if self.command_gait == "stand" or self.command_gait == "sit":
            ...
            # Foot Position in body frame when body control is fixed ground
            ...
            if self.command_gait == "trot" or self.command_gait == "bound" or self.command_gait == "pace":
                self.Balance()
                self.rot = [self.roll_correction, self.pitch_correction, self.yaw]
